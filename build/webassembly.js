...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'build/webassembly.data';
      var REMOTE_PACKAGE_BASE = 'webassembly.data';
  ...
  Module['FS_createPath']("/", "data", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_build/webassembly.data');

      };
      Module['addRunDependency']('datafile_build/webassembly.data');
   ...
   loadPackage({"files": [{"filename": "/data/file.txt", "start": 0, "end": 179, "audio": 0}, {"filename": "/data/file.js", "start": 179, "end": 350, "audio": 0}, {"filename": "/data/container.jpg", "start": 350, "end": 185289, "audio": 0}], "remote_package_size": 185289, "package_uuid": "dd73a31c-9713-433f-b32e-7f819631054a"});
