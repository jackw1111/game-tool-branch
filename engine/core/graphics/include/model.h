...
public:
    ...
    Shader ourShader;
    glm::mat4 model;
    //static std::vector<std::vector<Model>> modelRegistry;

    Model(){};

    // constructor, expects a filepath to a 3D model.
    void setup(string const &path, bool gamma = false)
    {
        loadModel(path);
        ourShader.setup(_vShader2, _fShader2);
        model = glm::mat4(1.0f);
        //Model::modelRegistry[0].push_back(*this);
    }
...
unsigned int TextureFromFile2(const char *path, const string &directory, bool gamma)
{
