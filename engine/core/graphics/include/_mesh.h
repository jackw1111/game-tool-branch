...
public:
    ...
    // constructor
    Mesh(vector<Vertex2> vertices, vector<unsigned int> indices, vector<Texture2> textures)
    {
...
private:
    ...
    void setupMesh()
    {
        ...
        glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex2), (void*)offsetof(Vertex2, TexCoords));
