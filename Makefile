...
asm:
	...
	emcc Cube.cpp /home/me/spinning-cube/assimp/lib/libassimp.a -I./assimp/include -L./assimp/lib -I./ -o build/asmjs.html -s ALLOW_MEMORY_GROWTH=1 -s ERROR_ON_UNDEFINED_SYMBOLS=0 -s USE_WEBGL2=1 -s USE_GLFW=3 -s WASM=0 -s USE_FREETYPE=1  -s STB_IMAGE=1 --preload-file data -std=c++1z --bind
